void drawheader() {
  ...
  textFont(font24,24);
  fill(255);                        
  text(heading,(20),(45)); //left baseline of textbox controls position, referenced to screen coordinates
  ...
  switch(pageValue) {
    case 1:   //Navigation bar outlines for +Activity page
      fill(menuActive);
      rect(0,73,320/4,(24));
      fill(menuInactive);
    ...
    case 3: 
      //Navigation bar outlines  Daily (formerly home) page
      fill(menuInactive);
      rect(0,73, 320/4,(24  ));
      rect( 320/4,73, 320/4,(24  ));
      fill(menuActive);
  ...
  text(activ,(0 + 6  ),(75 ),320/4,(24 ));
  
  String log = "Log";
  text(log,(320/4 + 25  ),(75 ),320/4,(24 )); 
  
  String home = "Daily";
  text(home,(2*320/4 + 20  ),(75 ), 320/4,(24 )); 
 ...
 //If it is, change the fill for the "+Activity" menu item
  if (activOver == true) {
    fill(menuHighlight);
    rect(0,73,320/4,(24));
    fill(255);
 ...
 //Check whether the mouse is over the "Daily" menu item
